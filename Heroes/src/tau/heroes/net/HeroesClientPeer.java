...
public class HeroesClientPeer extends NetworkPeer {
	...
	public NetworkResult<Boolean> Login(String username, String password,
		...
		if (reply == null)
			...
			return new NetworkResult<Boolean>(false, ((ErrorMessage) reply)
					.getText());
		else
			return new NetworkResult<Boolean>(false, "Unknown Reply");
	}

	public NetworkResult<Boolean> Register(String username, String password,
			String email, String nickname) {
		RegisterRequestMessage message = new RegisterRequestMessage(username,
